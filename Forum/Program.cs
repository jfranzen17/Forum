...
namespace Interface
{
    class Program
    {
            ...
            while (true)
            {
                ...
                if (x == "1")
                {
                    ...
                    while (true)
                    {
                        ...
                        Console.Clear();
                        var threadCreator = userRepo.GetUserWhoCreatedThread(threadId);
        ...
        public static void ListPostInThread(PostRepository repository, int threadId)
        {

            var thread = repository.GetThreadWithId(threadId);
            var posts = repository.GetPostFromThread(thread);
        ...
        public static void PrintThreads(ThreadRepository repository)
        {
        ...
        public static void PrintUsers(UserRepository repository)
        {
